...
.badge {
  ...
  padding:4px 8px; border-radius:999px; border:1px solid #334155;
  color: var(--muted); font-size:12px;
}
.price { font-weight:700; color: var(--accent); }
.button-primary {
  background: linear-gradient(135deg, var(--primary), var(--accent));
  color:#0b1220; border:0; padding:8px 12px; border-radius:8px; font-weight:600;
}
...
/* Filters grid: aligned heights and responsive columns */
.filters {
  display:grid;
